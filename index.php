...
<main class="container-fluid container-xl">
    ...
    <div class="row bg-grøn mb-4">
        <div class="col-12 col-md-6 order-md-1 p-4">
            <h2>Hos os er alle velkomne</h2>
            <p>
                Vi elsker at vise vores have frem til alle
                der kommer forbi.
                <br>
                <br>
                Veteranhaven er ikke kun for dig der har PTSD- symptomer, det kan også være du har en kæreste med PTSD eller er pårørende til en veteran. Det kan også være du har brug for et fællesskab.
                <br>
                <br>
                Måske har du en helt anden grund til at komme forbi, men faktisk behøver du ikke have en grund, for vi har åbent for alle.
